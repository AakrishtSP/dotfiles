...
complete -c yt-x --no-files --short-option x --long-option extension --description 'The extension to use' --condition 'not __fish_seen_subcommand_from completions' --exclusive --arguments "(command ls /home/asp/.config/yt-x/extensions)"
