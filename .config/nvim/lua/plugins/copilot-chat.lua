return {
	...
	opts = {
		...
		prompts = {
			...
			SwaggerApiDocs = "Please provide Swagger API documentation for the following code.",
			SwaggerJSDoc = "Please write JSDoc for the following API code.",
	...
	keys = {
		...
		{ "<leader>ccg", "<cmd>CopilotChatTests<cr>", desc = "CopilotChat - Generate tests" },
